...
class AudioMessage extends \ProtobufMessage
{
    ...
    {
        return $this->values[self::SIZE];
    }
    public function getDuration()
    {
        return $this->values[self::DURATION];
    }
    ...
    {
        $this->values[self::SIZE] = $newValue;
    }
    public function setDuration($newValue)
    {
        $this->values[self::DURATION] = $newValue;
    }
    public function setACoded($newValue)
    {
        $this->values[self::ACODEC] = $newValue;
    }
...
class VideoMessage extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::UNK_1] = null;
        $this->values[self::CAPTION] = null;
        $this->values[self::UNK_3] = null;
        $this->values[self::UNK_4] = null;
        $this->values[self::UNK_5] = null;
        $this->values[self::REFKEY] = null;
        $this->values[self::THUMBNAIL] = null;
    }
